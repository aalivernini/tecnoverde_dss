...
<main id="pgmain">
    ...
    <div class="content-page">
        ...
        foreach ($tables as $table) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                foreach ($row as $column => $data) {
                    ...
                    if ($column == "id" || $column == "id_specie" || $column == "created") {
                        ...
                        echo "<td><input  type='text' name='value' value='$data'></td>";
                        echo "<td class='d-none'><input   type='hidden' name='table' value='$table'></td>";
                        echo "<td class='d-none'><input   type='hidden' name='column' value='$column'></td>";
                        echo "<td class='d-none'><input   type='hidden' name='id' value='$target_id'></td>";
                    }
                }
                echo "</tr>";
            }
            echo "</tbody>";
            echo "</table>";
            echo " <input class='btn btn-info' type='submit' name='update' value='Aggiorna'>";
